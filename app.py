# -*- coding: utf-8 -*-
# Sør-Norge Weather Intelligence Dashboard (Final Version with Map Fix)
...
import pytz  # kan brukes senere hvis behov
...
def geocode_city(city_name: str):
    """Hent koordinater for en by via Open-Meteo Geocoding API."""
